...
*/
const A187 = '馃懢EDBOT2108馃懢'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/_sadboy.ig'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+62895377298173'; // JANGAN UBAH-UBAH INFO!!!
const aktif = 'Tergantung jaringan'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'https://chat.whatsapp.com/KVUUb1SJgqv1kdZ2bCQiD5'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'https://m.youtube.com/channel/UC6Bs6w1UY3dc_XBttPLQ8pg'; // JANGAN UBAH-UBAH INFO!!!
//A187ID
...
conn.sendMessage(id, ' _3aalaikumsalam, _Iyah aku disini kak...ada yang bisa kami bantu? Ketik *#menu* untuk melihat fitur bot kami馃檹_ ' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, ' _Waalaikumsalam, Iyah aku disini kak...ada yang bisa kami bantu? Ketik *#menu* untuk melihat fitur bot kami馃檹_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' _Iyah aku disini kak...ada yang bisa kami bantu? Ketik *#menu* untuk melihat fitur bot kami馃檹_ ' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, ' _Iyah aku disini kak...ada yang bisa kami bantu? Ketik *#menu* untuk melihat fitur bot kami馃檹_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' _Pagi juga, Iyah aku disini kak...ada yang bisa kami bantu? Ketik *#menu* untuk melihat fitur bot kami馃檹_ ' ,MessageType.text);
}
else if (text == 'Siang'){
conn.sendMessage(id, ' _Siang juga, Iyah aku disini kak...ada yang bisa kami bantu? Ketik *#menu* untuk melihat fitur bot kami馃檹_ ' ,MessageType.text);
}
else if (text == 'Sore'){
conn.sendMessage(id, ' _Sore juga, Iyah aku disini kak...ada yang bisa kami bantu? Ketik *#menu* untuk melihat fitur bot kami馃檹_ ' ,MessageType.text);
}
else if (text == 'Malam'){
conn.sendMessage(id, ' _Malam juga, Iyah aku disini kak...ada yang bisa kami bantu? Ketik *#menu* untuk melihat fitur bot kami馃檹_ ' ,MessageType.text);
}
...
conn.sendMessage(id, ' _love you too馃樆_ ' ,MessageType.text);
}
else if (text == 'Mas'){
conn.sendMessage(id, ' _Iyah aku disini kak...ada yang bisa kami bantu? Ketik *#menu* untuk melihat fitur bot kami馃檹_ ' ,MessageType.text);
}
  ...
  var teks = text.replace(/#nulis /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[WAIT] Searching...鉂�', MessageType.text)
...
axios.get(`https://alfians-api.herokuapp.com/api/yta?url=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] Searching...鈴�', MessageType.text)
...
if (text.includes("#infoig")){
  ...
  conn.sendMessage(id, '[WAIT] Searching...鈴�', MessageType.text)
  let hasil = `BIODATA INSTAGRAM ATAS NAMA _${teks}_ \n\n *Username鉁嶏笍* : _${res.data.Username}_ \n *Nama鉁嶏笍* : _${res.data.Name}_ \n *Jumlah Followers鉁嶏笍* : _${res.data.Jumlah_Followers}_ \n *Jumlah Following鉁嶏笍* : _${res.data.Jumlah_Following}_ \n *Jumlah Post鉁嶏笍* : _${res.data.Jumlah_Post}_ `;
  conn.sendMessage(id, hasil, MessageType.text);
})
}
if (text.includes("#infogempa")){
  ...
  conn.sendMessage(id, '[WAIT] Searching...鈴�', MessageType.text)
  let hasil = ` *INFO GEMPA* \n\ *Lokasi* : _${res.data.lokasi}_ \n *Kedalaman鉁嶏笍* : _${res.data.kedalaman}_ \n *Koordinat鉁嶏笍* : _${res.data.koordinat}_ \n *Magnitude鉁嶏笍* : _${res.data.magnitude}_ \n *Waktu鉁嶏笍* : _${res.data.waktu}_ `;
  conn.sendMessage(id, hasil, MessageType.text);
})
}
...
axios.get(`https://mhankbarbar.herokuapp.com/api/twit?url=${teks}&apiKey=zFuV88pxcIiCWuYlwg57`).then((res) => {
	conn.sendMessage(id, '[WAIT] Searching...鉂�', MessageType.text)
    let hasil = `芒艙鈥erhasil$ silahkan klik link di bawah untuk mendownload hasilnya$\nKlik link dibawah冒鸥鈥斅∶嘎廫n\nSize: ${res.data.filesize}\n\nLink: ${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`http://scrap.terhambar.com/tiktokfull?link=${tictoc}`).then((res) => {
	 conn.sendMessage(id, '[WAIT] Searching...鉂�', MessageType.text)
     let titoe = `芒艙鈥erhasil$$$ Silahkan klik link dibawah ini untuk mendownload hasilnya$ \nKlik link dibawah冒鸥鈥斅∶嘎廫n\nJudul: ${res.data.deskripsi} \n\nDurasi: ${res.data.durasi}\n\nNama: ${res.data.nama}\n\nUrl: ${res.data.urlvideo}`;
...
axios.get(`https://alfians-api.herokuapp.com/api/ig?url=${teks}`).then((res) => {
    let hasil = `鉁匘wonload sendiri link error maaf\n\nLink: ${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`https://alfians-api.herokuapp.com/api/wiki?q=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] Searching...鉂�', MessageType.text)
    let hasil = ` *馃懇鈥嶐煉籑enurut Wikipedia:馃懇鈥嶐煉�* \n\n _${res.data.result}_ `;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
const get = require('got')
    ...
    conn.sendMessage(id,` *馃攷DATA WABAH COVID-19 TERBARU DI INDONESIA馃攳* \n\n *馃搱Positif ==>* _${positif}_ \n馃搲 *Sembuh ==>* _${sembuh}_ \n *馃搵Meninggal ==>* _${meninggal}_ \n *馃棐锔廌irawat ==>* _${dirawat}_ `, MessageType.text);
}
...
馃悾馃悾馃悾馃悾馃悾馃悾馃悾馃悾馃悾馃悾馃悾馃悾馃悾

         Nama _*${nama}*_ ${h}
         
馃惀馃惀馃惀馃惀馃惀馃惀馃惀馃惀馃惀馃惀馃惀馃惀馃惀
